...
interface SolidPluginSettings {
	mySetting: string;
}

const DEFAULT_SETTINGS: SolidPluginSettings = {
	mySetting: "default",
};

export default class SolidPlugin extends Plugin {
	settings: SolidPluginSettings;
	...
	async onload() {
		...
		this.addRibbonIcon("solid-icon", "Solid Plugin", (evt: MouseEvent) => {
			this.showPane(SOLID_VIEW_TYPE);
		});
...
// 	constructor(app: App, plugin: SolidPlugin) {
// 		super(app, plugin);
// 		this.plugin = plugin;
// 	}
